...
from protein_folding_environment.movement_utils import move_to_new_state_3d
from utils.plotting_utils import plot_HPSandbox_conf_3D
...
class ProteinFolding3DEnv(gym.Env):
